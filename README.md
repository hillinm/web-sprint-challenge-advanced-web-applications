...
A token can be read by react to make decisions for data transfer based on the client's permission. 

2. What steps can you take in your web apps to keep your data secure?

We can use protected routes and by send authentication header with our API calls.

3. Describe how web servers work.

They are machines that receive our code and interpret it, then they serve it back to as web pages to users upon request.
